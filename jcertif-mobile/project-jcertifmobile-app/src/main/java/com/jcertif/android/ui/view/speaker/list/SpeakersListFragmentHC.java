 ...
 */
public class SpeakersListFragmentHC extends ListFragment {
	/**
	...
	public void onResume() {
		...
		// Define header title
		getActivity().getActionBar().setTitle(getResources().getString(R.string.speaker_list_htitle));
		super.onResume();
	}
	...
	public SpeakersListCallBack getCallBack() {
		if (callback == null) {
			callback = (SpeakersListCallBack) ((MainActivityHC) getActivity()).getFragmentSwitcher();
		}
		return callback;
	}
